...
/**
 *
 * @author Adriano Local Esta Interface é chamada em vários locais diferentes do
 * sistema, portanto ela foi projetada de forma que identifique de qual
 * interface ela foi invocada para que possa retornar para ela. exemplo: se a
 * tela de cadastro de paciente chamar esta tela , ela saberá que foi a tela
 * pelos parâmetros que foram passados, pois a quantidade e o tipo de parâmetro
 * determina qual construtor será usado.
 */
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jButton1))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jNotificacao, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//if(jPesquisa.getText().trim().equals("")) jPesquisa.setText("Digite o nome do responsável aqui!");        // TODO add your handling code here:        // TODO add your handling code here:
    ...
    private void jPesquisaMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPesquisaMouseReleased
        if (jPesquisa.getText().trim().equals("")) {
            jPesquisa.setText("Digite o nome do responsável aqui!");        // TODO add your handling code here:        // TODO add your handling code here:
        }
...
//    boolean retorno = false;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (Codigojanela == 1) {
            ...
            if (Codigojanela == 2) {
                try {
                    //Quando um prontuário será reservado para alguem este if será chamado
                    System.out.println("codigo da janela 2");
                    ChamaTelaPesquisarProntuarioReservar();
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ResponsavelProntuario.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
...
//CodigoJanela=1 Emprestar prontuário, codigojanela=2 reservar prontuário
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            new sctp2.Prontuarios.Prontuario(codigo).setVisible(true);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ResponsavelProntuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jPesquisaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPesquisaKeyTyped
        if (jPesquisa.getText().trim().equals("Digite o nome do responsável aqui!")) {
            jPesquisa.setText("");        // TODO add your handling code here:        // TODO add your handling code here:
        }
    ...
    private void ChamaCadastroProntuario() throws ClassNotFoundException {
        if (envia == null) {//se for igual a null significa que nao existe nehuma chave para acessar a interface prontuario
            ...
            envia.Recebe(codigo, (String) jTable1.getValueAt(jTable1.getSelectedRow(), 1), (String) jTable1.getValueAt(jTable1.getSelectedRow(), 2), (String) jTable1.getValueAt(jTable1.getSelectedRow(), 3), (String) jTable1.getValueAt(jTable1.getSelectedRow(), 0), null, null, null);
            this.setVisible(false);
        } else {
            envia.setVisible(true);
    ...
    private void AdicionaNovoResponsavelChamaTelaProntuario() throws ClassNotFoundException {
        try {
            PassaValoresResponsavel();//Passa os valores para classe de Prontuario e grava no BD
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ResponsavelProntuario.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if (envia == null) {
            envia = new Prontuario();
            envia.setVisible(true);
            envia.RecebeReservadeProntuario(codigo, nomeresponsavel.getText(), jFTelefoneFixo.getText(), jFTelefoneFixo.getText(), Idresponsavel, nomeProfessorResponsavel.getText(), jFTelefoneFixoProfessor.getText(), jFTelefoneCelularProfessor.getText());
            this.setVisible(false);//envia os dados adicionados para a internface Prontuario e fecha esta tela
        } else {
            envia.setVisible(true);
            envia.setState(Prontuario.NORMAL);
    ...
    private void AdicionarResponsaveleChamaTelaPesquisarProntuario() throws ClassNotFoundException {
        ...
        if (enviar == null) {
            ...
            enviar.Recebe(codigo, nomeresponsavel.getText(), jFTelefoneFixo.getText(), jFTelefoneFixo.getText(), Idresponsavel, nomeProfessorResponsavel.getText(), jFTelefoneFixoProfessor.getText(), jFTelefoneCelularProfessor.getText());
            this.setVisible(false);
        } else {
            enviar.setVisible(true);
