...
public class Prontuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("Ver Prontuários por Responsável");
        ...
        jEditarProntuario.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jEditarProntuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/clipboard.png"))); // NOI18N
        jEditarProntuario.setText("Editar Prontuário");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(38, 38, 38)
                .addComponent(jEditarProntuario, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jEditarProntuario, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jLabel2.setText("Nome ,RG ou Nº prontuario ");
        ...
        jBprontuario.setText("Devolver Prontuario");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jDateEmprestimoInicio, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jDateEmprestimoFim, javax.swing.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE))))
        ...
        jLocalizacaoProntuario.setEditable(false);
        jLocalizacaoProntuario.setBackground(new java.awt.Color(255, 255, 255));
                            ...
                            .addGroup(jDetalhesProntuarioLayout.createSequentialGroup()
                                ...
                                .addGroup(jDetalhesProntuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jDetalhesProntuarioLayout.createSequentialGroup()
                                        ...
                                        .addGap(126, 126, 126))
                                    .addComponent(jLocalizacaoProntuario))))
                        .addGap(23, 23, 23))))
        );
    ...
    private void jEditarProntuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEditarProntuarioActionPerformed
        try {
            new EditarProntuario(codigoProntuario).setVisible(true);
              this.setVisible(false);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Prontuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void Pesquisar() throws ClassNotFoundException {
        boolean retorno = false;
        retorno = PesquisarPorNumeroProntuario();
        if (retorno == false) {
            retorno=PesquisarProntuarioPorRG();
        }
        else
        if (retorno == false) {
            retorno=PesquisarProntuarioPorNomePaciente();
    ...
    private boolean PesquisarPorNumeroProntuario() throws ClassNotFoundException {
        ...
        if (ListarPesquisa.isEmpty()) {
            ...
            if (ListarPesquisa.get(0).getStatus().equals("Emprestado")) {
                jBprontuario.setText("Devolver Prontuário");
            }
...
//Nprontuario.setText(codigo);
    ...
    private void MostraDetalhesProntuario() {
        ...
        if (false == (ListarPesquisa.get(linha).getStatus().equals("Disponivel"))) {//Se o prontuario não estiver disponivel
            jPanel3.setVisible(true);
            jPanel4.setVisible(true);
            label1.setText("Detalhes do Prontuário");
            label2.setText(ListarPesquisa.get(linha).getStatus() + " para:");
            NomeresponsavelProntuario.setText(ListarPesquisa.get(linha).getNome());
            ...
            jLocalizacaoProntuario.setText("Localização física: "+ListarPesquisa.get(linha).getLocalizacaoProntuario());
            codigoProntuario= ListarPesquisa.get(linha).getCodigoProntuario();//variavel armazena o código do prontuario
    ...
    private boolean PesquisarProntuarioPorNomePaciente() throws ClassNotFoundException {
        sctp2.BancodeDados.conexao acesso = new sctp2.BancodeDados.conexao();
        DefaultTableModel valor = (DefaultTableModel) jTable1.getModel();//criando a chave valor para o objeto tabela
        ListarPesquisa = new ArrayList<>();
        jBprontuario.setEnabled(false);//desativa o botao de emprestar/receber
        ListarPesquisa = acesso.PesquisarProntuarioporNomePaciente(jProntuario.getText());
        if (ListarPesquisa.isEmpty()) {
            jTNotificacao.setForeground(Color.red);
            jTNotificacao.setText("Nenhum prontuário encontrado!");
        } else {
    ...
    private boolean PesquisarProntuarioPorRG() throws ClassNotFoundException {
        sctp2.BancodeDados.conexao acesso = new sctp2.BancodeDados.conexao();
        DefaultTableModel valor = (DefaultTableModel) jTable1.getModel();//criando a chave valor para o objeto tabela
        ListarPesquisa = new ArrayList<>();
        jBprontuario.setEnabled(false);//desativa o botao de emprestar/receber
        ListarPesquisa = acesso.PesquisarProntuarioporRG(jProntuario.getText());
        if (ListarPesquisa.isEmpty()) {
            jTNotificacao.setForeground(Color.red);
            jTNotificacao.setText("Nenhum prontuário encontrado!");
        } else {
