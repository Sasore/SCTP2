...
public class Pesquisar {
    ...
    public int getGrupodeRisco() {
        return grupodeRisco;
    }

    public void setGrupodeRisco(int grupodeRisco) {
        this.grupodeRisco = grupodeRisco;
    }

    public int getPacienteAlta() {
        return pacienteAlta;
    }

    public void setPacienteAlta(int pacienteAlta) {
    ...
    public void setListaNegra(int listaNegra) {
