...
ArrayList<sctp2.ClassesdeControle.TratamentosNecessarios> ListarTratamentos;
    /**
...
this.setVisible(false);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        tratamento[0]=ListarTratamentos.get(linha).getProfilaxiaSimples();System.out.println("lista sizr"+ListarTratamentos.size());
...
if(  tratamento[0]==1)valor.addRow((new String[]{"Profilaxia Simples"}));System.out.println("endondotia "+tratamento[20]);
...
if(  tratamento[9]==1)valor.addRow((new String[]{"EndontiaUnirradicular e birradicular"}));
...
//        ArrayList<sctp2.Pesquisar.Paciente.HistoricoPaciente> ListarPesquisa;
        ...
        ListarTratamentos=new ArrayList<sctp2.ClassesdeControle.TratamentosNecessarios>();
      ...
      ListarTratamentos=acesso.PesquisarHistóricoTratamentos(rg);
        if(ListarPesquisa.size()==0)jNotificacao.setText("Não há histórico para este usuário!");
        else{
